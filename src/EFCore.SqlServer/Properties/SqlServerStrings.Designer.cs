...
namespace Microsoft.EntityFrameworkCore.SqlServer.Internal
{
    ...
    public static class SqlServerStrings
    {
        ...
        /// <summary>
        ///     The query is attempting to query a JSON collection of binary data in a context that requires preserving the ordering of the collection; this isn't support by SQL Server.
        /// </summary>
