...
public class ModelSnapshotSqlServerTest
{
    ...
    [ConditionalFact]
    public virtual void Trigger_is_stored_in_snapshot_as_fluent_api()
        => Test(
            builder =>
            {
                builder.Entity<EntityWithOneProperty>()
    ...
    [ConditionalFact]
    public virtual void Triggers_and_ExcludeFromMigrations_are_stored_in_snapshot_as_fluent_api()
        => Test(
            builder =>
            {
                builder.Entity<EntityWithOneProperty>()
