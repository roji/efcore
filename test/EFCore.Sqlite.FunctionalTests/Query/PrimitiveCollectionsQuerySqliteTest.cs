...
""");
    ...
    public override async Task Column_collection_Intersect_constant_collection(bool async)
    {
        await base.Column_collection_Intersect_constant_collection(async);
...
""");
    ...
    public override async Task Constant_collection_Except_column_collection(bool async)
    {
        await base.Constant_collection_Except_column_collection(async);
...
""");
    ...
    public override async Task Column_collection_Concat_parameter_collection_equality_constant_collection_not_supported(bool async)
    {
        await base.Column_collection_Concat_parameter_collection_equality_constant_collection_not_supported(async);

        AssertSql();
    }

    public override async Task Column_collection_equality_constant_collection(bool async)
    {
        await base.Column_collection_equality_constant_collection(async);
