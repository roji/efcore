...
WHERE 0 = 1
ORDER BY [o].[Id], [t].[Id], [t0].[ClientId], [t0].[Id]");
        }
...
ORDER BY [t0].[Id], [t1].[ClientId], [t1].[Id]");
        }
...
ORDER BY [o].[Id], [p].[Id], [t].[ClientId], [t].[Id]");
        }
...
ORDER BY [t].[Id], [t0].[ClientId], [t0].[Id]");
        }
...
ORDER BY [o].[Name], [o].[Id], [t].[ClientId], [t].[Id]");
        }
...
ORDER BY [o].[PersonAddress_PlaceType], [o].[Id], [t].[ClientId], [t].[Id]");
        }
...
ORDER BY [o].[Id], [t].[Id], [t].[Id0], [t0].[Id], [t0].[Id0], [t2].[Id], [t2].[Id0], [t4].[Id], [t4].[Id0], [t6].[ClientId], [t6].[Id]");
        }
