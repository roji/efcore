...
ORDER BY [t].[Id], [t].[MasterTrunk22340Id], [t].[MasterTrunk22340Id0], [f0].[CurrencyBag22340MasterTrunk22340Id], [f0].[Id]");
            }
        }
...
ORDER BY [t].[Id], [t1].[DateArrived] DESC");
        }
