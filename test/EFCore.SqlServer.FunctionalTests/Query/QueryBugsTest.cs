...
""");
    ...
    public virtual async Task Nested_contains_with_enum()
    {
        ...
        using (var context = contextFactory.CreateContext())
        {
            ...
            // Note that in thie query, the outer Contains really has no type mapping, neither for its source (collection parameter), nor
    ...
    protected class MyContext17253 : DbContext
    {
        ...
        public void Seed()
        {
            ...
            EntitiesReferencingEntityWithQueryFilterSelfReference.Add(
                new EntityReferencingEntityWithQueryFilterSelfReference { Name = "EntityReferencingEntityWithQueryFilterSelfReference" });
